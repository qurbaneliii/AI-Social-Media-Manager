# FILE: apps/visual-understanding/main.py
...
async def lifespan(app: FastAPI):
    ...
    app.state.db_pool = await asyncpg.create_pool(settings.database_url, min_size=1, max_size=8)
    app.state.vector_db_pool = await asyncpg.create_pool(settings.database_url, min_size=1, max_size=8)
...
app = FastAPI(title="visual-understanding", version="1.0.0", lifespan=lifespan)
