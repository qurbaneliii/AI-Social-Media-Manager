...
create policy storage_media_member_insert on storage.objects for insert to authenticated with check (bucket_id = 'media-assets');
create policy storage_media_member_update on storage.objects for update to authenticated using (bucket_id = 'media-assets') with check (bucket_id = 'media-assets');
create policy storage_media_member_delete on storage.objects for delete to authenticated using (bucket_id = 'media-assets');
